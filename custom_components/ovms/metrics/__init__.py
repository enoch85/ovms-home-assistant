...
METRIC_CATEGORIES = {
    ...
    CATEGORY_MG_ZS_EV: [
        k
        for k, v in METRIC_DEFINITIONS.items()
        if v.get("category") == CATEGORY_MG_ZS_EV
    ],
    CATEGORY_NISSAN_LEAF: [
        k
        for k, v in METRIC_DEFINITIONS.items()
        if v.get("category") == CATEGORY_NISSAN_LEAF
    ],
    CATEGORY_RENAULT_TWIZY: [
        k
        for k, v in METRIC_DEFINITIONS.items()
        if v.get("category") == CATEGORY_RENAULT_TWIZY
    ],
}
...
PREFIX_CATEGORIES = {
    ...
    "xsq.12v": CATEGORY_SMART_FORTWO,
    "xsq.adc": CATEGORY_SMART_FORTWO,
    "xsq.bcm": CATEGORY_SMART_FORTWO,
    "xsq.bms": CATEGORY_SMART_FORTWO,
    "xsq.ddt4all": CATEGORY_SMART_FORTWO,
    "xsq.driver": CATEGORY_SMART_FORTWO,
    "xsq.ed4": CATEGORY_SMART_FORTWO,
    "xsq.evc": CATEGORY_SMART_FORTWO,
    "xsq.obd": CATEGORY_SMART_FORTWO,
    "xsq.obl": CATEGORY_SMART_FORTWO,
    "xsq.odometer": CATEGORY_SMART_FORTWO,
    "xsq.poll": CATEGORY_SMART_FORTWO,
    "xsq.tpms": CATEGORY_SMART_FORTWO,
